    ...
    async handlePath(pathFunc, options = {}) {
        ...
        const checkPosition = () => {
            try {
                ...
                this.#logDebug(`Checking if bot is stuck during handlePath, position: ${this.vecToString(currentPosition)}, previousPosition: ${this.vecToString(previousPosition)}, isMining: ${this.#bot.pathfinder.isMining()}, chestIdOpen: ${this.#chestIdOpen}, isCrafting: ${this.isCrafting}`)
