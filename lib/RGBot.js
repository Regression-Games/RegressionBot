...
const RGBot = class {
    ...
    /**
     * Enable or disable use of parkour during pathfinding. Parkour is disabled by default.
     * Enabling this may allow your Bot to reach goals faster and place fewer blocks to achieve upwards movement.
            ...
            try {
                if (await this.approachBlock(block)) {
                    ...
                    if (block.drops && block.drops.length > 0) {
                        droppedItem = this.findItemOnGround(block.drops[0]);
                    } else {
